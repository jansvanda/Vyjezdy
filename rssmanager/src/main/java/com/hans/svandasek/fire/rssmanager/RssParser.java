...
public class RssParser extends AsyncTask<String, Integer, String> {
    ...
    protected String doInBackground(String... strings) {
        try {
            Document rssDocument = Jsoup.connect(mUrl).ignoreContentType(true).parser(Parser.xmlParser()).timeout(10 * 1000).get();
    ...
    protected void onPostExecute(String s) {
        ...
        if (s.equals("success")) {
            ...
            mOnFeedLoadListener.onFailure("Chyba při čtení odkazu\n" + mUrl);
        }
    }
}
