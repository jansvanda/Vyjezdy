...
import com.hans.svandasek.fire.vyjezdy.models.Categories;
...
public class FeedsRecyclerViewAdapter extends RecyclerView.Adapter<FeedsRecyclerViewAdapter.FeedsViewHolder> {
    ...
    public void onBindViewHolder(FeedsRecyclerViewAdapter.FeedsViewHolder holder, int position) {
        ...
        holder.mTxtDistrict.setText(mFeedItems.get(position).getItemDistrict());
    ...
    public class FeedsViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        private TextView mTxtTitle, mTxtSource, mTxtSourceUrl, mTxtCategory, mTxtPubDate, mTxtDistrict;
        ...
        public FeedsViewHolder(View itemView) {
            ...
            mTxtDistrict = (TextView) itemView.findViewById(R.id.text_view_district);
        ...
        public void onClick(View view) {
            ...
            Log.e("loadinglink", mFeedItems.get(getAdapterPosition()).getItemLink());
        ...
        private void setFontSize() {
            ...
            mTxtDistrict.setTextSize(TypedValue.COMPLEX_UNIT_SP, SettingsPreferences.FEED_PUBLISH_DATE_SIZE);
