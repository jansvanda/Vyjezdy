...
import com.hans.svandasek.fire.mindb.DatabaseOperations;
        ...
        if (cursor != null && cursor.getCount() != 0) {
            if (cursor.moveToFirst()) {
                do {
                    ...
                    feedItem.setItemDistrict(cursor.getString(cursor.getColumnIndex(columnNames[2])));
                    feedItem.setItemLink(cursor.getString(cursor.getColumnIndex(columnNames[3])));
                    feedItem.setItemImgUrl(cursor.getString(cursor.getColumnIndex(columnNames[4])));
                    feedItem.setItemCategory(cursor.getString(cursor.getColumnIndex(columnNames[5])));
                    feedItem.setItemSource(cursor.getString(cursor.getColumnIndex(columnNames[6])));
                    feedItem.setItemSourceUrl(cursor.getString(cursor.getColumnIndex(columnNames[7])));
                    feedItem.setItemPubDate(cursor.getString(cursor.getColumnIndex(columnNames[8])));
                    feedItem.setItemCategoryImgId(Integer.parseInt(cursor.getString(cursor.getColumnIndex(columnNames[9]))));
                    feedItem.setItemWebDesc(cursor.getString(cursor.getColumnIndex(columnNames[10])));
