...
public class FeedItem {
    private String itemTitle, itemDesc, itemDistrict, itemSourceUrl, itemLink, itemImgUrl, itemCategory, itemSource, itemPubDate, itemWebDesc, itemWebDescSync;
    ...
    public void setItemDistrict(String itemDistrict) {
