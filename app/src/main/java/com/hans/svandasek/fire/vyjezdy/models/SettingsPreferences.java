...
public class SettingsPreferences {
    ...
    public static void init(Context context) {
                ...
                setDistricts(context, defaultSharedPreferences);
    ...
    private static void setDistricts(Context context, SharedPreferences defaultSharedPreferences) {

        String notifkey = context.getResources().getString(R.string.notifications_district);
        String districts = defaultSharedPreferences.getString(notifkey, "Všechny okresy");

        switch (districts) {
            case "Žádné oznámení":
                FirebaseMessaging.getInstance().unsubscribeFromTopic("ALL");
                FirebaseMessaging.getInstance().unsubscribeFromTopic("blansko");
                FirebaseMessaging.getInstance().unsubscribeFromTopic("brnomesto");
                FirebaseMessaging.getInstance().unsubscribeFromTopic("brnovenkov");
                FirebaseMessaging.getInstance().unsubscribeFromTopic("breclav");
                FirebaseMessaging.getInstance().unsubscribeFromTopic("hodonin");
                FirebaseMessaging.getInstance().unsubscribeFromTopic("vyskov");
                FirebaseMessaging.getInstance().unsubscribeFromTopic("znojmo");
                break;
            ...
            case "Blansko":
                FirebaseMessaging.getInstance().subscribeToTopic("blansko");
            ...
            case "Brno-město":
                FirebaseMessaging.getInstance().subscribeToTopic("brnomesto");
            ...
            case "Brno-venkov":
                FirebaseMessaging.getInstance().subscribeToTopic("brnovenkov");
            ...
            case "Břeclav":
                FirebaseMessaging.getInstance().subscribeToTopic("breclav");
            ...
            case "Hodonín":
                FirebaseMessaging.getInstance().subscribeToTopic("hodonin");
                ...
                break;
            case "Vyškov":
                FirebaseMessaging.getInstance().subscribeToTopic("vyskov");
            ...
            case "Znojmo":
                FirebaseMessaging.getInstance().subscribeToTopic("znojmo");
    ...
    private static void setTheme(Context context, SharedPreferences defaultSharedPreferences) {
        ...
        String theme = defaultSharedPreferences.getString(themeKey, "Světlý");
